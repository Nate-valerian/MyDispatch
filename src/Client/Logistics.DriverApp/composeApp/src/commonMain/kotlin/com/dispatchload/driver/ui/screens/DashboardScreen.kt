...
import com.dispatchload.driver.model.driversList
...
import com.dispatchload.driver.ui.components.DutyStatusCard
import com.dispatchload.driver.ui.components.LoadCard
import com.dispatchload.driver.ui.components.TripCard
        ...
        PullToRefreshBox(
            ...
            UiStateContent(uiState, viewModel::refresh) { dashboardData ->
                ...
                LazyColumn(
                        ...
                        if (dashboardData.isLoadFinderEnabled && !dashboardData.isLoadFinderExpired()) {
                            item {
