 ...
 * inspection components can render it. Both [com.dispatchload.driver.viewmodel.DvirDefect]
 * (truck DVIR) and [com.dispatchload.driver.viewmodel.ConditionDefect] (cargo
