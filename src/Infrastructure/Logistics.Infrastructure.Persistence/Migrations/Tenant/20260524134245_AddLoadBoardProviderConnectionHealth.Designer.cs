...
namespace Logistics.Infrastructure.Persistence.Migrations.Tenant
{
    ...
    [Migration("20260524134245_AddLoadBoardProviderConnectionHealth")]
    partial class AddLoadBoardProviderConnectionHealth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.ConditionDefect", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("LoadConditionReportId")
                        .HasColumnType("uuid")
                        .HasColumnName("load_condition_report_id");

                    b.Property<string>("PartCategory")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("part_category");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_condition_defects");

                    b.HasIndex("LoadConditionReportId")
                        .HasDatabaseName("ix_condition_defects_load_condition_report_id");

                    b.HasIndex("PartCategory")
                        .HasDatabaseName("ix_condition_defects_part_category");

                    b.ToTable("condition_defects", (string)null);
                });
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.Container", b =>
                {
                    ...
                    b.Property<string>("BillOfLadingNumber")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("bill_of_lading_number");
                    ...
                    b.Property<Guid?>("CurrentTerminalId")
                        .HasColumnType("uuid")
                        .HasColumnName("current_terminal_id");
                    ...
                    b.Property<bool>("IsLaden")
                        .HasColumnType("boolean")
                        .HasColumnName("is_laden");

                    b.Property<string>("IsoType")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("iso_type");
                    ...
                    b.HasIndex("CurrentTerminalId")
                        .HasDatabaseName("ix_containers_current_terminal_id");

                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("ix_containers_number");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.DriverLicense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("IssuingRegion")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("issuing_region");

                    b.Property<DateTime?>("LastReminderSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_reminder_sent_at");

                    b.Property<int?>("LastReminderThresholdDays")
                        .HasColumnType("integer")
                        .HasColumnName("last_reminder_threshold_days");
                    ...
                    b.Property<DateTime?>("MedicalCertExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("medical_cert_expires_at");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_driver_licenses");

                    b.HasIndex("DocumentId")
                        .HasDatabaseName("ix_driver_licenses_document_id");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_driver_licenses_expires_at");

                    b.HasIndex("EmployeeId", "LicenseNumber", "IssuingCountry")
                        .IsUnique()
                        .HasDatabaseName("ix_driver_licenses_employee_id_license_number_issuing_country");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.Employee", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Address", "Logistics.Domain.Entities.Employee.Address#Address", b1 =>
                        {
                            b1.Property<string>("City")
                                .IsRequired()
                                .HasColumnType("text")
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.Load", b =>
                {
                    ...
                    b.Property<string>("HazmatClass")
                        .HasColumnType("text")
                        .HasColumnName("hazmat_class");

                    b.Property<bool>("IsHazmat")
                        .HasColumnType("boolean")
                        .HasColumnName("is_hazmat");

                    b.Property<bool>("IsInProximity")
                        .HasColumnType("boolean")
                        .HasColumnName("is_in_proximity");
                    ...
                    b.Property<DateTime?>("RequestedPickupDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("requested_pickup_date");
                    ...
                    b.HasIndex("ContainerId")
                        .HasDatabaseName("ix_loads_container_id");

                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_loads_customer_id");

                    b.HasIndex("DestinationTerminalId")
                        .HasDatabaseName("ix_loads_destination_terminal_id");
                    ...
                    b.HasIndex("OriginTerminalId")
                        .HasDatabaseName("ix_loads_origin_terminal_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.LoadBoardConfiguration", b =>
                {
                    ...
                    b.Property<string>("LastConnectionError")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("last_connection_error");

                    b.Property<DateTime?>("LastConnectionTestedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_connection_tested_at");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.LoadConditionReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_load_condition_reports");

                    b.HasIndex("ContainerNumber")
                        .HasDatabaseName("ix_load_condition_reports_container_number");

                    b.HasIndex("InspectedAt")
                        .HasDatabaseName("ix_load_condition_reports_inspected_at");

                    b.HasIndex("InspectedById")
                        .HasDatabaseName("ix_load_condition_reports_inspected_by_id");

                    b.HasIndex("LoadId")
                        .HasDatabaseName("ix_load_condition_reports_load_id");

                    b.HasIndex("Vin")
                        .HasDatabaseName("ix_load_condition_reports_vin");

                    b.ToTable("load_condition_reports", (string)null);
                });
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.TelegramChat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ChatId")
                        .IsUnique()
                        .HasDatabaseName("ix_telegram_chats_chat_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_telegram_chats_user_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.Terminal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Address", "Logistics.Domain.Entities.Terminal.Address#Address", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ix_terminals_code");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.Truck", b =>
                {
                    ...
                    b.Property<bool>("IsHazmatPlacarded")
                        .HasColumnType("boolean")
                        .HasColumnName("is_hazmat_placarded");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "AdrEquipment", "Logistics.Domain.Entities.Truck.AdrEquipment#AdrEquipment", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<DateTime?>("AdrCertExpiresAt")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("adr_equipment_adr_cert_expires_at");

                            b1.Property<string>("AllowedClasses")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("adr_equipment_allowed_classes");

                            b1.Property<bool>("IsAdrCertified")
                                .HasColumnType("boolean")
                                .HasColumnName("adr_equipment_is_adr_certified");

                            b1.Property<string>("OrangePlateNumber")
                                .HasMaxLength(8)
                                .HasColumnType("character varying(8)")
                                .HasColumnName("adr_equipment_orange_plate_number");
                        });
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.LoadDocument", b =>
                {
                    ...
                    b.HasIndex("LoadConditionReportId")
                        .HasDatabaseName("ix_documents_load_condition_report_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.ConditionDefect", b =>
                {
                    b.HasOne("Logistics.Domain.Entities.LoadConditionReport", "LoadConditionReport")
                        .WithMany("Defects")
                        .HasForeignKey("LoadConditionReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_condition_defects_load_condition_report_load_condition_repo");

                    b.Navigation("LoadConditionReport");
                });
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.Container", b =>
                {
                    b.HasOne("Logistics.Domain.Entities.Terminal", "CurrentTerminal")
                        ...
                        .HasConstraintName("fk_containers_terminal_current_terminal_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.DriverLicense", b =>
                {
                    b.HasOne("Logistics.Domain.Entities.EmployeeDocument", "Document")
                        .WithMany()
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_driver_licenses_document_document_id");
                    ...
                    b.HasOne("Logistics.Domain.Entities.Employee", "Employee")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_driver_licenses_employee_employee_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.Load", b =>
                {
                    ...
                    b.HasOne("Logistics.Domain.Entities.Container", "Container")
                        .WithMany()
                        .HasForeignKey("ContainerId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_loads_containers_container_id");
                    ...
                    b.HasOne("Logistics.Domain.Entities.Terminal", "DestinationTerminal")
                        .WithMany()
                        .HasForeignKey("DestinationTerminalId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_loads_terminal_destination_terminal_id");

                    b.HasOne("Logistics.Domain.Entities.Terminal", "OriginTerminal")
                        .WithMany()
                        .HasForeignKey("OriginTerminalId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_loads_terminal_origin_terminal_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.LoadConditionReport", b =>
                {
                    b.HasOne("Logistics.Domain.Entities.Employee", "InspectedBy")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_load_condition_reports_employees_inspected_by_id");
                    ...
                    b.HasOne("Logistics.Domain.Entities.Load", "Load")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_load_condition_reports_load_load_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.LoadDocument", b =>
                {
                    b.HasOne("Logistics.Domain.Entities.LoadConditionReport", null)
                        .WithMany("Photos")
                        .HasForeignKey("LoadConditionReportId")
                        .HasConstraintName("fk_documents_load_condition_reports_load_condition_report_id");
