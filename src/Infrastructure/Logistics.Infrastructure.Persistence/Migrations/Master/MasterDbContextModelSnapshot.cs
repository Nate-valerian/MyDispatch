...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.ImpersonationAuditLog", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_impersonation_audit_logs");

                    b.HasIndex("AdminUserId")
                        .HasDatabaseName("ix_impersonation_audit_logs_admin_user_id");

                    b.HasIndex("TargetUserId")
                        .HasDatabaseName("ix_impersonation_audit_logs_target_user_id");

                    b.HasIndex("Timestamp")
                        .HasDatabaseName("ix_impersonation_audit_logs_timestamp");

                    b.HasIndex("WasSuccessful", "Timestamp")
                        .HasDatabaseName("ix_impersonation_audit_logs_was_successful_timestamp");

                    b.ToTable("impersonation_audit_logs", (string)null);
                });

            modelBuilder.Entity("Logistics.Domain.Entities.ImpersonationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_impersonation_tokens");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_impersonation_tokens_expires_at");

                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("ix_impersonation_tokens_token");

                    b.HasIndex("IsUsed", "ExpiresAt")
                        .HasDatabaseName("ix_impersonation_tokens_is_used_expires_at");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.TelegramLoginState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ResolvedRole")
                        .HasColumnType("text")
                        .HasColumnName("resolved_role");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_telegram_login_states");

                    b.HasIndex("State")
                        .IsUnique()
                        .HasDatabaseName("ix_telegram_login_states_state");

                    b.ToTable("telegram_login_states", (string)null);
                });
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Settings", "Logistics.Domain.Entities.Tenant.Settings#TenantSettings", b1 =>
                        {
                            ...
                            b1.Property<bool?>("LlmExtendedThinking")
                                .HasColumnType("boolean")
                                .HasColumnName("settings_llm_extended_thinking");
